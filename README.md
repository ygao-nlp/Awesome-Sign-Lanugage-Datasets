# 🌍 Multilingual Sign Language Datasets
This repository documents multilingual sign language benchmark datasets for researchers.

Our goal is to support multilingual, cross-cultural sign language understanding and generation by leveraging diverse large-scale datasets.
...
## 🆕 New Dataset: New Zealand Sign Language (NZSL)

To further enhance multilingual coverage, we are collecting a new dataset for **New Zealand Sign Language (NZSL)**.
...
Our work focuses on improving **efficacy, generalization, and cultural coverage** of sign language AI systems.

---

## 📎 Citation

If you find this repository useful in your research, please consider citing our work (coming soon).

---

## 🤝 Acknowledgements

We thank the maintainers of all open-access datasets and the NZSL community for making this research possible.
